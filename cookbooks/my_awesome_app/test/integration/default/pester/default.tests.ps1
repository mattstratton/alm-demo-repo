...
describe 'iis::default'  {
    ...
    It "Should not have a default website" {
      Get-Website -Name "Default Web Site" | Should be $false
    }
    It "Should have our website" {
      Get-Website -Name "my_awesome_app" | Should be $false
      (Get-Website -Name "my_awesome_app").State | Should be "Started"
    }
    ...
    It "Should have our app pool" {
     Get-WebAppPoolState -Name "my_awesome_app" | Should be $true
     (Get-WebAppPoolState -Name "my_awesome_app").value | Should be "Started"
    }
}
